...
import com.tickets.tickets.repository.UserAccountRepository;
...
public class TicketServiceImpl implements TicketService {
    ...
    public TicketServiceImpl(UserRepository userRepository, EventRepository eventPostgresRepository,
    ...
    private void throwRuntimeExceptionIfEventNotExist(String eventId) {
        if (!eventPostgresRepository.existsById(eventId)) {
